    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 bg-gray-100 p-8 relative space-y-6">
          {/* Saldo Card */}
          <div className="flex items-center justify-between bg-text-gray rounded-lg p-4 shadow-md">
            <div className="flex items-center">
              <GiWallet className="w-16 h-16 text-green mr-4" />
              <div>
            ...
            <button
              ...
              className="bg-transparent w-10 h-10 rounded-full flex items-center justify-center hover:text-green-bue"
            >
              <FaPlusCircle className="text-green text-4xl hover:text-green-bue" />
            </button>
          </div>
          ...
          {isAdding && (
            <div className="flex items-center mt-4">
              ...
              <button
                ...
                className="ml-4 bg-green text-white p-2 rounded-lg hover:bg-green-bue"
              >
                Simpan
              </button>
            </div>
          ...
          {/* Tabel Transaksi */}
          <div className="bg-text-grayrounded-lg p-6 shadow-md">
