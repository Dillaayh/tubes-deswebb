...
const PesanTiket = () => {
  ...
  return (
    <div className="flex flex-col items-center bg-white min-h-screen font-poppins">
      <Header />
      <div className="w-full max-w-3xl bg-light-green p-8 shadow-lg rounded-lg mt-8 sm:mt-12 relative">
        ...
        <div className="flex justify-end mt-6">
          <Link
            ...
            className="bg-greentext-white text-xs sm:text-sm px-4 py-2 rounded-full border border-black hover:bg-green"
