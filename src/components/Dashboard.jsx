...
const Jadwalkereta = () => {
  ...
  return (
    <div className="App">
      <Header />
      <div className="flex justify-center items-center min-h-screen bg-auto">
        <div
          className="bg-light-green p-6 rounded-[25px] px-8 py-6 mx-auto"
          style={{
            width: "1300px",
            height: "450px",
        ...
        >
          ...
          {showResults && (
            <div className="cpntainer mx-auto p-8 mt-6">
              <h3 className="bg-green-custom p-6 rounded-lg shadow-lg text-center font-bold mb-4 ">
                JADWAL KERETA
              </h3>
              <ul className="space-y-4">
                {scheduleResults.map((schedule, index) => (
                  <li
                    key={index}
                    className="flex justify-between p-4 bg-light-green rounded-lg shadow-md space-x-4"
                  >
                    ...
                    <div className="w-1/6 flex items-center justify-center">
                      <Link
                        ...
                        className="bg-green font-bold text-white text-base sm:text-lg px-6 py-2 rounded-full border border-black hover:bg-green flex item-center justify-center"
                      >
                        Pesan
                      </Link>
                    </div>
