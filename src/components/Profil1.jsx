    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <div className="flex flex-1">
        ...
        <aside className="bg-light-green w-[375px] h-[914px] p-8 relative">
          ...
          <div className="relative w-20 h-20 bg-gray-300 rounded-full mx-auto mb-4">
            <img
              src={profileImage || 'images/Profil.png'}
              alt="Poto Profil"
              className="w-full h-full rounded-full object-cover"
            />
            {/* Ikon edit yang selalu muncul di dekat foto profil */}
            <label htmlFor="file-upload" className="absolute bottom-0 right-0 mb-1 mr-1">
              <img
                src="images/edit.png" // Ikon edit (ganti dengan ikon yang sesuai)
                alt="Edit"
                className="w-6 h-6 bg-white rounded-full border-2 border-gray-300 p-1 cursor-pointer"
              />
            </label>
              <input
                type="file"
            ...
            <nav className="text-black font-poppins font-medium text-[25px] flex flex-col items-center justify-center pt-10">
        ...
        <main className="flex-1 bg-white p-8 relative">
          ...
          <button
            className="absolute bottom-20 right-12 w-[153px] h-[49px] bg-green font-poppins font-bold text-white text-[20px] py-2 px-4 rounded-lg hover:bg-light-green"
